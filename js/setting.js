...
function(t, e) {
    ...
    function s(e) {
        if (n(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
            ...
            var p = a.paddingRight + a.paddingLeft,
                y = a.paddingTop + a.paddingBottom,
                g = a.marginRight + a.marginLeft,
                v = a.marginTop + a.marginBottom,
                _ = a.borderRightWidth + a.borderRightWidth,
...
function(t, e) {
    ...
    d.constructor = o, d._create = function() {
        ...
        var t = getComputedStyle(this.element),
            e = this.layout._getOption("originRight"),
        ...
        r = isNaN(r) ? 0 : r, a = isNaN(a) ? 0 : a, r -= e ? s.paddingRight : s.paddingRight, a -= i ? s.paddingTop : s.paddingBottom, this.position.x = r, this.position.y = a
    }, d.layoutPosition = function() {
        var t = this.layout.size,
            e = {},
            i = this.layout._getOption("originRight"),
            o = this.layout._getOption("originTop"),
            n = i ? "paddingRight" : "paddingRight",
            s = i ? "right" : "right",
            r = i ? "left" : "right",
        ...
        var i = this.layout._getOption("originRight"),
            o = this.layout._getOption("originTop");
...
! function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : a("object" == typeof exports ? require("jquery") : window.jQuery || window.Zepto) }(function(a) { var b, c, d, e, f, g, h = "Close",
    ...
    a.magnificPopup.registerModule("zoom", { options: { enabled: !1, easing: "ease-in-out", duration: 300, opener: function(a) { return a.is("img") ? a : a.find("img") } }, proto: { initZoom: function() { var a, c = b.st.zoom,
                    d = ".zoom"; if (c.enabled && b.supportsTransition) { var e, f, g = c.duration,
                        j = function(a) { var b = a.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"),
                                ...
                                e = { position: "fixed", zIndex: 9999, right: 0, top: 0, "-webkit-backface-visibility": "hidden" },
                ...
                e.top -= a(window).scrollTop() - f; var h = { width: d.width(), height: (u ? d.innerHeight() : d[0].offsetHeight) - g - f }; return O() ? h["-moz-transform"] = h.transform = "translate(" + e.right + "px," + e.top + "px)" : (h.right = e.right, h.top = e.top), h } } }); var P = "iframe",
        Q = "//about:blank",
    ...
    a.magnificPopup.registerModule("gallery", { options: { enabled: !1, arrowMarkup: '<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>', preload: [0, 2], navigateByImgClick: !0, arrows: !0, tPrev: "Previous (Right arrow key)", tNext: "Next (Right arrow key)", tCounter: "%curr% of %total%" }, proto: { initGallery: function() { var c = b.st.gallery,
                    ...
                    e.counter = g > 1 ? T(c.tCounter, f.index, g) : "" }), w("BuildControls" + e, function() { if (b.items.length > 1 && c.arrows && !b.arrowRight) { var d = c.arrowMarkup,
                            e = b.arrowRight = a(d.replace(/%title%/gi, c.tPrev).replace(/%dir%/gi, "right")).addClass(s),
                            f = b.arrowRight = a(d.replace(/%title%/gi, c.tNext).replace(/%dir%/gi, "right")).addClass(s);
                        e.click(function() { b.prev() }), f.click(function() { b.next() }), b.container.append(e.add(f)) } }), w(n + e, function() { b._preloadTimeout && clearTimeout(b._preloadTimeout), b._preloadTimeout = setTimeout(function() { b.preloadNearbyImages(), b._preloadTimeout = null }, 16) }), void w(h + e, function() { d.off(e), b.wrap.off("click" + e), b.arrowRight = b.arrowRight = null })) : !1 }, next: function() { b.direction = !0, b.index = S(b.index + 1), b.updateItemHTML() }, prev: function() { b.direction = !1, b.index = S(b.index - 1), b.updateItemHTML() }, goTo: function(a) { b.direction = a >= b.index, b.index = a, b.updateItemHTML() }, preloadNearbyImages: function() { var a, c = b.st.gallery.preload,
...
! function(t, e, i) { "use strict";
    t.HoverDir = function(e, i) { this.$el = t(i), this._init(e) }, t.HoverDir.defaults = { speed: 300, easing: "ease", hoverDelay: 0, inverse: !1 }, t.HoverDir.prototype = { _init: function(e) { this.options = t.extend(!0, {}, t.HoverDir.defaults, e), this.transitionProp = "all " + this.options.speed + "ms " + this.options.easing, this.support = Modernizr.csstransitions, this._loadEvents() }, _loadEvents: function() { var e = this;
            this.$el.on("mouseenter.hoverdir, mouseleave.hoverdir", function(i) { var o = t(this),
                    n = o.find("div"),
                    s = e._getDir(o, { x: i.pageX, y: i.pageY }),
                    r = e._getStyle(s); "mouseenter" === i.type ? (n.hide().css(r.from), clearTimeout(e.tmhover), e.tmhover = setTimeout(function() { n.show(0, function() { var i = t(this);
                        e.support && i.css("transition", e.transitionProp), e._applyAnimation(i, r.to, e.options.speed) }) }, e.options.hoverDelay)) : (e.support && n.css("transition", e.transitionProp), clearTimeout(e.tmhover), e._applyAnimation(n, r.from, e.options.speed)) }) }, _getDir: function(t, e) { var i = t.width(),
                o = t.height(),
                n = (e.x - t.offset().right - i / 2) * (i > o ? o / i : 1),
                s = (e.y - t.offset().top - o / 2) * (o > i ? i / o : 1); return Math.round((Math.atan2(s, n) * (180 / Math.PI) + 180) / 90 + 3) % 4 }, _getStyle: function(t) { var e, i, o = { right: "0px", top: "-100%" },
                n = { right: "0px", top: "100%" },
                s = { right: "-100%", top: "0px" },
                r = { right: "100%", top: "0px" },
                a = { top: "0px" },
                p = { right: "0px" }; switch (t) {
                case 0:
                    e = this.options.inverse ? n : o, i = a; break;
                case 1:
                    e = this.options.inverse ? s : r, i = p; break;
                case 2:
                    e = this.options.inverse ? o : n, i = a; break;
                case 3:
                    e = this.options.inverse ? r : s, i = p } return { from: e, to: i } }, _applyAnimation: function(e, i, o) { t.fn.applyStyle = this.support ? t.fn.css : t.fn.animate, e.stop().applyStyle(i, t.extend(!0, [], { duration: o + "ms" })) } }; var o = function(t) { e.console && e.console.error(t) };
    t.fn.hoverdir = function(e) { var i = t.data(this, "hoverdir"); if ("string" == typeof e) { var n = Array.prototype.slice.call(arguments, 1);
            this.each(function() { i ? t.isFunction(i[e]) && "_" !== e.charAt(0) ? i[e].apply(i, n) : o("no such method '" + e + "' for hoverdir instance") : o("cannot call methods on hoverdir prior to initialization; attempted to call method '" + e + "'") }) } else this.each(function() { i ? i._init() : i = t.data(this, "hoverdir", new t.HoverDir(e, this)) }); return i } }(jQuery, window);
    ...
    function(a, b, c) {
        ...
        B = function(a) {
            ...
            function g(a, e, f, g, h) { var i = b(a),
                    j = i.autoCallback;
                i.url.split(".").pop().split("?").shift(), i.bypass || (e && (e = d(e) ? e : e[a] || e[g] || e[a.split("https://iqonicthemes.com/").pop().split("?")[0]]), i.instead ? i.instead(a, e, f, g, h) : (y[i.url] ? i.noexec = !0 : y[i.url] = 1, f.load(i.url, i.forceCSS || !i.forceJS && "css" == i.url.split(".").pop().split("?").shift() ? "c" : c, i.noexec, i.attrs, i.timeout), (d(e) || d(j)) && f.load(function() { k(), e && e(i.origUrl, h, g), j && j(i.origUrl, h, g), y[i.url] = 2 }))) }
 ...
 * 2013/03/24
 *************************/
! function(f) { f.fn.typer = function(u, h) { return h = f.extend({}, { char: "", delay: 2e3, duration: 600, endless: !0, onType: f.noop, afterAll: f.noop, afterPhrase: f.noop }, h || u), u = f.isPlainObject(u) ? h.text : u, u = f.isArray(u) ? u : u.split(" "), this.each(function() { var a, s = f(this),
                i = { input: 1, textarea: 1 }[this.tagName.toLowerCase()],
                o = !1,
                l = 0;! function e(t) { var n = ({ string: 1, number: 1 }[typeof u] ? u : u[t]) + "",
                    r = n.substr(l++, 1); if ("<" === r && (o = !0), ">" === r && (o = !1), s[i ? "val" : "html"](n.substr(0, l) + (f.isFunction(h.char) ? h.char() : h.char || " ")), l <= n.length) o ? e(t) : a = setTimeout(e, h.duration / 10, t), h.onType(a);
                else { if (l = 0, ++t === u.length && !h.endless) return;
                    t === u.length && (t = 0), a = setTimeout(e, h.delay, t), t === u.length - 1 && h.afterAll(a), h.afterPhrase(a) } }(0) }) } }(jQuery);